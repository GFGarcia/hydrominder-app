...
const buttonStyle = tva({
	...
	variants: {
		action: {
			primary:
				"bg-theme-dark data-[hover=true]:bg-theme-dark data-[active=true]:bg-theme-dark border-0 data-[hover=true]:border-theme-dark data-[active=true]:border-theme-dark",
			secondary:
				"bg-theme-text border-0 data-[hover=true]:bg-theme-text data-[active=true]:bg-theme-text",
			positive:
