...
export const tableHeadStyle = tva({
	base: "flex-1 text-left font-bold text-[16px] leading-[22px] text-typography-800 font-roboto",
});
...
export const tableDataStyle = tva({
	base: "flex-1 text-left text-[16px] font-medium leading-[22px] text-typography-800 font-roboto",
});
